...
class Menu extends \yii\widgets\Menu
{
    ...
    public $linkTemplateToggle = "<a href=\"{url}\" class=\"menu-dropdown\">\n{icon}\n{label}\n{right-icon}\n{badge}</a>";

    public $activeCssClass = 'open';
     ...
     * @var string
     */
    public $parentRightIcon = '<i class="menu-expand"></i>';
    ...
    protected function renderItem($item)
    {
        ...
        if (isset($item['url'])) {
            ...
            if(isset($item['is_toggle'])){
                $template = ArrayHelper::getValue($item, 'template', $this->linkTemplateToggle);
            }
