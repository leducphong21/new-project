        ...
        <div class="table-toolbar">
            <div class="widget">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group ">Trạng thái
                            <span class="input-icon icon-right">
                             <?=Html::activeDropDownList($model, 'status',['1'=>'Chưa mở thuê','2'=>'Mở thuê'],['prompt'=>'Chọn trạng thái','class' => 'form-control','style'=> 'width:100%'],['maxlenght'=> true])?>
