...
use common\models\project\ProductRentSub;
use common\models\project\ProductRentSubSearch;
 ...
 */
class ProductRentSubController extends Controller
{
    ...
    {
        $searchModel = new ProductRentSubSearch();
