...
use common\models\project\ProductMediumSub;
use common\models\project\ProductMediumSubSearch;
 ...
 */
class ProductMediumSubController extends Controller
{
    ...
    {
        $searchModel = new ProductMediumSubSearch();
