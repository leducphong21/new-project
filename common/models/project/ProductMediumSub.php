 ...
 */
class ProductMediumSub extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return \common\models\project\query\ProductMediumQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\project\query\ProductMediumSubQuery(get_called_class());
    }
