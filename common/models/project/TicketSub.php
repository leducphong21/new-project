 ...
 */
class TicketSub extends \yii\db\ActiveRecord
{
    public $name;
    /**
     * @inheritdoc
    ...
    /**
     * @inheritdoc
     * @return \common\models\project\query\TicketSubQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\project\query\TicketSubQuery(get_called_class());
    }
