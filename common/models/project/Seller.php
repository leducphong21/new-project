...
class Seller extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\project\query\SellerQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\project\query\SellerQuery(get_called_class());
    }
