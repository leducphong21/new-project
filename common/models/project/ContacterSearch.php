...
/**
 * ContacterSearch represents the model behind the search form about `common\models\project\Contacter`.
 */
class ContacterSearch extends Contacter
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Contacter::find()->where(["type" => 4])->active();
