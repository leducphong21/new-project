 ...
 */
class Contacter extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return \common\models\project\query\ContacterQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\project\query\ContacterQuery(get_called_class());
    }
