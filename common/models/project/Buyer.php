...
class Buyer extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\project\query\BuyerQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\project\query\BuyerQuery(get_called_class());
    }
