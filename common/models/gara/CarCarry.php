 ...
 */
class CarCarry extends \yii\db\ActiveRecord
{
    public $product;
    /**
     * @inheritdoc
    ...
    /**
     * @return CarCarryQuery
     */
    public static function find()
    {
        return new CarCarryQuery(get_called_class());
    }
    ...
    public function getCarCount()
    {
        ...
        return $this->hasMany(Car::className(), [ 'car_carry_id' => 'id'])->count();
    }
